    ...
    return (
        <div className='bg-black text-white'>
            <div className='py-3 px-3 max-w-[1490px] mx-auto flex items-center justify-between gap-1 lg:gap-3'>
                <a to="/"className='text-lg font-semibold'>ShoeShack</a>
                ...
                {menu && <div className='absolute top-0 bottom-0 left-0 z-10 w-64 h-screen bg-black'>
                    <div className='flex-col px-3 pt-2 text-lg font-medium'>
                        <a onClick={() => smallScreenNavigate("home")} className='block pb-1' to="/">Home</a>
                        <a onClick={() => smallScreenNavigate("all categories")} className='block pb-1'>All Categories</a>
                        <a onClick={() => smallScreenNavigate("mens")} className='block pb-1'>Mens</a>
                        <a onClick={() => smallScreenNavigate("womens")} className='block pb-1'>Womens</a>
                        <a onClick={() => smallScreenNavigate("brands")} className='block'>Brands</a>
                    </div>
